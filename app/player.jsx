...
import {
    ...
    randomActionCard,
    genNewCard,
    randomActionCardCurrentJunction,
        ...
        <SafeAreaView className="flex-1 w-full h-full box-border bg-gray-900">
            ...
            <Player
                ...
                handleNoValidMove={() => {
                    ...
                    showToast(
                        "Your card1 is randomized to a new action card. Better luck next time."
                    );
                    const updatedCards = [...myCards];
                    const newCard = randomActionCardCurrentJunction();
                    ...
                    if (isPlayer2) {
                        store.setPlayer2CurrentCards(updatedCards);
                        store.setPlayerToMove("player1");
                    } else {
                        store.setPlayer1CurrentCards(updatedCards);
                        store.setPlayerToMove("player2");
                    }
                }}
            />
